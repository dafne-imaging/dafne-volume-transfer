...
from dafne_sam2.automatic.checkpoints import CHECKPOINT_MODELS
...
os.environ.setdefault("DAFNE_SAM2_CHECKPOINT",
                       os.path.join(_CKPT_DIR, _ckpt_details["file_name"]))
os.environ.setdefault("DAFNE_SAM2_MODEL_CFG", _ckpt_details["config"])
